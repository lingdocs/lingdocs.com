...
A compound verb is a verb that's made by combining an auxilary/helper verb and something else (a complement).
...
<SimpleFormula items={[
    ...
    <div>
        <strong>helper verb</strong>
        <div>(auxilary verb)</div>
    </div>,
    <strong>compound verb</strong>,
]}/>
...
If we're using a feminine object <IW w={{ p: "هغه", f: "haghá", e: "her", a: "" }} />, we need to inflect the complement/adjective <IW w={{ p: "ستړی", f: "stúRe", e: "tired" }} /> to <IW w={{ p: "ستړې", f: "stúRe" }} />.
...
And when we combine this inflectable adjective with the helper verb they get fused togethre like this:
...
- Always use <IW w={{ p: "کول", f: "kawul", e: "to make" }} /> as the helper/auxilary verb
...
<table className="table table-bordered" style={{ tableLayout: "fixed", textAlign: "center" }}>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Uses <IW w={{ p: "کول", e: "to do" }} />, which does take a <IW w={{ p: "و", f: "óo", e: "perfective prefix" }} />, or other helper verbs</td>
        </tr>
        <tr>
